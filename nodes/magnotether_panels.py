...
class ExpScript(object):
    ...
    def __init__(self):
        ...
        event_table = [
                ...
                Event(5.0,    functools.partial(self.show_pattern, pattern_id=4, gain_x=1)),
                Event(125.0,   self.do_nothing),
                Event(126.0,   functools.partial(self.show_pattern, pattern_id=5, gain_x=1)),
                Event(246.0,  self.do_nothing),
                Event(247.0,  functools.partial(self.show_pattern, pattern_id=8, gain_x=1)),
                Event(367.0,  self.do_nothing),
                Event(368.0,  functools.partial(self.show_pattern, pattern_id=6, gain_x=1)),
                Event(488.0,  self.do_nothing),
                Event(489.0,  functools.partial(self.show_pattern, pattern_id=7, gain_x=1)),
                Event(609.0,  self.do_nothing),
                Event(610.0,   functools.partial(self.show_pattern, pattern_id=2, gain_x=1)),
                Event(730.0,  self.do_nothing),
                Event(731.0,  functools.partial(self.show_pattern, pattern_id=1, gain_x=1)),
                Event(851.0,  self.do_nothing),
                Event(852.0,  functools.partial(self.show_pattern, pattern_id=3, gain_x=1)),
...
#on 07/10/18 changed gain from 30
    ...
    def show_pattern(self, pattern_id, gain_x):
        ...
        self.ctrl.stop()
        self.ctrl.send_gain_bias(gain_x = gain_x, bias_x = 0,gain_y = 0,bias_y =0)

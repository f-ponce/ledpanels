...
#        self.exp_duration = 973 # run the experiment for exp_duration seconds
        self.exp_duration = 851 # run the experiment for exp_duration seconds
        ...
        event_table = [
                Event(0.0,    self.do_nothing  ),
                Event(1.0,    self.ctrl.all_on  ),
                Event(2.0,    self.ctrl.all_off ),
                Event(3.0,    self.ctrl.all_on  ),
                Event(4.0,    self.ctrl.all_off ),
                Event(5.0,    functools.partial(self.show_pattern, pattern_id=4, gain_x=30)),
                Event(125.0,   self.do_nothing),
                Event(126.0,   self.ctrl.stop ),
                Event(127.0,   self.ctrl.all_off ),
                Event(247.0,   functools.partial(self.show_pattern, pattern_id=5, gain_x=30)),
                Event(367.0,   self.do_nothing),
                Event(368.0,   self.ctrl.stop ),
                Event(369.0,   self.ctrl.all_off ),
                Event(489.0,   functools.partial(self.show_pattern, pattern_id=8, gain_x=30)),
                Event(609.0,   self.do_nothing),
                Event(610.0,   self.ctrl.stop ),
                Event(611.0,   self.ctrl.all_off ),
                Event(731.0,   functools.partial(self.show_pattern, pattern_id=6, gain_x=30)),
                Event(851.0,   self.do_nothing),
#                Event(19.0,   self.do_nothing),
#               Event(246.0,  self.do_nothing),
#                Event(247.0,  functools.partial(self.show_pattern, pattern_id=8, gain_x=30)),
#                Event(367.0,  self.ctrl.all_off),
#                Event(368.0,  self.do_nothing),
#                Event(488.0,  self.do_nothing),
#                Event(489.0,  functools.partial(self.show_pattern, pattern_id=7, gain_x=30)),
#                Event(609.0,  self.ctrl.all_off),
#                Event(610.0,  self.do_nothing),
#                Event(730.0,  self.do_nothing),
#                Event(731.0,  functools.partial(self.show_pattern, pattern_id=1, gain_x=30)),
#                Event(851.0,  self.ctrl.all_off),
#                Event(852.0,  self.ctrl.all_off),

...
#        tsun = 300 #sun time
        ...
        event_table = [
                Event(1.0,      functools.partial(self.show_pattern, pattern_id=SF[0], gain_x=0, bias_x = 0)),
                Event(181.0,    self.ctrl.stop),
                Event(182.0,    self.ctrl.all_off),
                Event(362.0,    self.do_nothing)]

#        event_table = [
#                Event(1.0,      functools.partial(self.show_pattern, pattern_id=SF[0], gain_x=0, bias_x = 0)),
#                Event(4.0,    self.ctrl.stop),
#                Event(5.0,    self.ctrl.all_off),
#                Event(9.0,    self.do_nothing)]

...
class ExpScript(object):
    ...
    def __init__(self):
        ...
        rospy.logwarn(shuffle_pids)

        #speeds = [1,2,4,8,32,128]
        speeds = [1,2,4,8,32,50]


        shuffle_speeds = speeds
        np.random.shuffle(shuffle_speeds)
        rospy.logwarn(shuffle_speeds)

#here I shuffle the patterns and speeds

        pids_speeds_i1 = [[5,speeds[0]],[5,speeds[1]],[5,speeds[2]],[5,speeds[3]],[5,speeds[4]],[5,speeds[5]],[6,speeds[0]],[6,speeds[1]],[6,speeds[2]],[6,speeds[3]],[6,speeds[4]],[6,speeds[5]]]
        pids_speeds_i2 = [[3,speeds[0]],[3,speeds[1]],[3,speeds[2]],[3,speeds[3]],[3,speeds[4]],[3,speeds[5]],[4,speeds[0]],[4,speeds[1]],[4,speeds[2]],[4,speeds[3]],[4,speeds[4]],[4,speeds[5]]]
...
#shuffle the gains for the stripe shown between patterns
        ...
        shuffle_pids_speeds_i1 = pids_speeds_i1
        np.random.shuffle(shuffle_pids_speeds_i1)
        rospy.logwarn(shuffle_pids_speeds_i1)
        sps1 = shuffle_pids_speeds_i1

        shuffle_pids_speeds_i2 = pids_speeds_i2
        np.random.shuffle(shuffle_pids_speeds_i2)
        rospy.logwarn(shuffle_pids_speeds_i2)
        sps2 = shuffle_pids_speeds_i2

        ts1 = 2
        ts = 2 #time of stripe between trials
        tp = 2 #time of pattern of ventral flow at certain speed
        ...
        event_table = [
                ...
                # exp pattern 1
                Event(6.0+ts1,                functools.partial(self.show_pattern, pattern_id=sps1[0][0], gain_x=sps1[0][1], bias_x = 0)),
                ...
                # exp pattern 2
                Event(8.0+ts1+tp+ts,          functools.partial(self.show_pattern, pattern_id=sps1[1][0], gain_x=sps1[1][1], bias_x = 0)),
                ...
                # exp pattern 3
                Event(10.0+ts1+tp*2+ts*2,     functools.partial(self.show_pattern, pattern_id=sps1[2][0], gain_x=sps1[2][1], bias_x = 0)),
                ...
                # exp pattern 4
                Event(12.0+ts1+tp*3+ts*3,     functools.partial(self.show_pattern, pattern_id=sps1[3][0], gain_x=sps1[3][1], bias_x = 0)),
                ...
                # exp pattern 5
                Event(14.0+ts1+tp*4+ts*4,     functools.partial(self.show_pattern, pattern_id=sps1[4][0], gain_x=sps1[4][1], bias_x = 0)),
                ...
                # exp pattern 6
                Event(16.0+ts1+tp*5+ts*5,     functools.partial(self.show_pattern, pattern_id=sps1[5][0], gain_x=sps1[5][1], bias_x = 0)),
                ...
                # exp pattern 7
                Event(18.0+ts1+tp*6+ts*6,     functools.partial(self.show_pattern, pattern_id=sps1[6][0], gain_x=sps1[6][1], bias_x = 0)),
                ...
                # exp pattern 8
                Event(20.0+ts1+tp*7+ts*7,     functools.partial(self.show_pattern, pattern_id=sps1[7][0], gain_x=sps1[7][1], bias_x = 0)),

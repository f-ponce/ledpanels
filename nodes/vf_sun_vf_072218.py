...
class ExpScript(object):
    ...
    def __init__(self):
        ...
        event_table = [
                ...
                Event(5.0,    functools.partial(self.show_pattern, pattern_id=2, gain_x=20)),
                Event(125.0,  self.do_nothing),
                Event(126.0,  functools.partial(self.show_pattern, pattern_id=4, gain_x=20)),
                Event(246.0,  self.do_nothing),
                Event(247.0,  functools.partial(self.show_pattern, pattern_id=5, gain_x=20)),
                Event(367.0,  self.do_nothing),
                Event(368.0,  functools.partial(self.show_pattern, pattern_id=7, gain_x=20)),
                Event(488.0,  self.do_nothing),
                Event(489.0,  self.ctrl.stop ),
                Event(490.0,  self.ctrl.all_off ),
                Event(791.0,  functools.partial(self.show_pattern, pattern_id=2, gain_x=20)),
                Event(911.0,  self.do_nothing),
                Event(912.0,  functools.partial(self.show_pattern, pattern_id=4, gain_x=20)),
                Event(1032.0, self.do_nothing),
                Event(1033.0, functools.partial(self.show_pattern, pattern_id=5, gain_x=20)),
                Event(1153.0, self.do_nothing),
                Event(1154.0, functools.partial(self.show_pattern, pattern_id=7, gain_x=20)),

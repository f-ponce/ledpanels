...
class ExpScript(object):
    ...
    def __init__(self):
        ...
        self.exp_duration = 46 # run the experiment for exp_duration seconds
        ...
        event_table = [
                ...
                Event(5.0,    functools.partial(self.show_pattern, pattern_id=shuffle_pids[0], gain_x=speeds[0])),
                Event(35.0,   self.do_nothing),
                Event(36.0,   functools.partial(self.show_pattern, pattern_id=shuffle_pids[1], gain_x=speeds[0])),
                Event(37.0,   self.do_nothing),
                Event(38.0,   functools.partial(self.show_pattern, pattern_id=shuffle_pids[0], gain_x=speeds[0])),
                Event(157.0,  self.do_nothing),
                Event(158.0,   functools.partial(self.show_pattern, pattern_id=shuffle_pids[0], gain_x=speeds[0])),
                Event(218.0,  self.do_nothing),
#                Event(47.0,  functools.partial(self.show_pattern, pattern_id=1, gain_x=10)),
#                Event(67.0,  self.do_nothing),
#                Event(368.0,  functools.partial(self.show_pattern, pattern_id=2, gain_x=10)),
#                Event(488.0,  self.do_nothing),
#                Event(489.0,  functools.partial(self.show_pattern, pattern_id=1, gain_x=20)),
#                Event(609.0,  self.do_nothing),
#                Event(610.0,   functools.partial(self.show_pattern, pattern_id=2, gain_x=20)),
#                Event(730.0,  self.do_nothing),
#                Event(731.0,  functools.partial(self.show_pattern, pattern_id=1, gain_x=5)),
#                Event(851.0,  self.do_nothing),
#                Event(852.0,  functools.partial(self.show_pattern, pattern_id=2, gain_x=5)),
#                Event(972.0,  self.do_nothing),
                ]
...
#on 07/10/18 changed gain from 30
    ...
    def show_pattern(self, pattern_id, gain_x):
        ...
        self.ctrl.send_gain_bias(gain_x = gain_x, bias_x = 0,gain_y = gain_x,bias_y =0)

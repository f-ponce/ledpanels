...
class ExpScript(object):
    ...
    def __init__(self):
        ...
        #1 - rotating stripe highest intensity
        #2 - rotating stripe
...
#shuffle the gains for the stripe shown between patterns
        ...
        ts1 = 60
        ts = 20 #time of stripe between trials
        ...
        event_table = [
                ...
                # stripe 30 s
                Event(5.0,                    functools.partial(self.show_pattern, pattern_id=1, gain_x=30, bias_x = 0)),
                ...
                # stripe 1
                Event(7.0+ts1+tp,             functools.partial(self.show_pattern, pattern_id=1, gain_x=ssg[0], bias_x = 0)),
                ...
                # stripe 2
                Event(9.0+ts1+tp*2+ts,        functools.partial(self.show_pattern, pattern_id=1, gain_x=ssg[1], bias_x = 0)),
                ...
                # stripe 3
                Event(11.0+ts1+tp*3+ts*2,     functools.partial(self.show_pattern, pattern_id=1, gain_x=ssg[2], bias_x = 0)),
                ...
                # stripe 4
                Event(13.0+ts1+tp*4+ts*3,     functools.partial(self.show_pattern, pattern_id=1, gain_x=ssg[3], bias_x = 0)),
                ...
                # stripe 5
                Event(15.0+ts1+tp*5+ts*4,     functools.partial(self.show_pattern, pattern_id=1, gain_x=ssg[4], bias_x = 0)),
                ...
                # stripe 6
                Event(17.0+ts1+tp*6+ts*5,     functools.partial(self.show_pattern, pattern_id=1, gain_x=ssg[5], bias_x = 0)),
                ...
                # stripe 7
                Event(19.0+ts1+tp*7+ts*6,     functools.partial(self.show_pattern, pattern_id=1, gain_x=ssg[0], bias_x = 0)),

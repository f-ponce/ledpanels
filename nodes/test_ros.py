...
#        self.ctrl.set_config_id(self.config_id)
        ...
        event_table = [
                ...
                Event(3.0,   self.do_nothing),
                Event(4.0   ,functools.partial(self.show_pattern, pattern_id=3, gain_x=30)),
                Event(10000.0,   self.do_nothing),
                Event(15.0   ,functools.partial(self.show_pattern, pattern_id=1, gain_x=30)),
                Event(25.0,   self.do_nothing)
                ]
